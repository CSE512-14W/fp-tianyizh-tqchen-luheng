...
../../xgboost/xgboost fusion.conf task=dump model_in=0004.model name_dump=dump.raw.txt 
# this is what dump will looklike with feature map
../../xgboost/xgboost fusion.conf task=dump model_in=0004.model fmap=featmap.txt name_dump=dump.nice.txt
